  ...
  return (
    <nav className="bg-white shadow-md py-4 px-6 flex justify-between items-center sticky top-0 z-50">
      ...
      <div className="hidden md:flex space-x-8">
        ...
        <a href="#pricing" className="hover:text-indigo-600 transition-colors font-medium">Pricing</a>
        <a href="#contact" className="hover:text-indigo-600 transition-colors font-medium">සම්බන්ධ වන්න</a>
      </div>
      <button className="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors font-semibold">
        Get Started
      </button>
    </nav>
  );
